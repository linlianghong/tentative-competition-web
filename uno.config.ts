...
export default defineConfig({
  shortcuts: [
    ['btn', 'text-center inline-block cursor-pointer rounded-10px border-1 border-primary border-solid min-h-30px w-14vw text-primary text-14px py-1/150vw transition-all transition-300 hover:(text-white bg-primary)'],
